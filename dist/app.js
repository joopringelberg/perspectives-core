...
(function(exports) {
  ...
  var Initialize = (function () {
      function Initialize(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      Initialize.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new Initialize(value0, value1, value2);
              };
          };
      };
      return Initialize;
  ...
  var aceComponent = function (mode) {
          ...
          var $$eval = function (v) {
              if (v instanceof Initialize) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("ace"))(function (v1) {
                      ...
                      if (v1 instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Ace.editNode(v1.value0)(Ace.ace)))(function (v2) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Ace_Editor.getSession(v2)))(function (v3) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Ace_EditSession.setMode(v.value0)(v3)))(function (v4) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Ace_Editor.setTheme(v.value1)(v2)))(function (v5) {
                      ...
                      throw new Error("Failed pattern match at PerspectAceComponent line 64, column 50 - line 74, column 91: " + [ v1.constructor.name ]);
                  }))(function () {
              ...
              if (v instanceof ChangeText) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at PerspectAceComponent line 83, column 7 - line 88, column 67: " + [ v1.constructor.name ]);
                      })())(function () {
              ...
              if (v instanceof HandleChange) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          ...
                          throw new Error("Failed pattern match at PerspectAceComponent line 93, column 7 - line 97, column 37: " + [ v1.constructor.name ]);
                      })())(function () {
              ...
              throw new Error("Failed pattern match at PerspectAceComponent line 62, column 10 - line 98, column 30: " + [ v.constructor.name ]);
          };
          return Halogen_Component.lifecycleComponent(Halogen_HTML_Core.bifunctorHTML)({
              initialState: Data_Function["const"](initialState), 
              render: render, 
              "eval": $$eval, 
              initializer: new Data_Maybe.Just(Halogen_Query.action(Initialize.create(mode)(theme))), 
...
(function(exports) {
  ...
  var TypeDeclaration = (function () {
      function TypeDeclaration(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      TypeDeclaration.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new TypeDeclaration(value0, value1, value2);
              };
          };
      };
  ...
  var showSimpleValue = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Perspectives.Syntax2 line 99, column 3 - line 99, column 27: " + [ v.constructor.name ]);
  });
  ...
  var showPerspectEntity = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Perspectives.Syntax2 line 92, column 3 - line 92, column 30: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var manyOneLineComments = Data_Array.many(Text_Parsing_Parser.alternativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser.lazyParserT)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_String.fromCharArray)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("--"))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(function (v) {
      return v !== "\x0a";
  })))(Text_Parsing_Parser_String.whiteSpace(Text_Parsing_Parser_String.stringLikeString)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))));
  ...
  var inLineComment = Text_Parsing_Parser_Combinators.optionMaybe(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameLine)(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Data_String.fromCharArray)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_String.string(Text_Parsing_Parser_String.stringLikeString)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))("--"))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(function (v) {
      return v !== "\x0a";
  })))(Text_Parsing_Parser_String.whiteSpace(Text_Parsing_Parser_String.stringLikeString)(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))))))));
  ...
  var emptyPropertyComments = Data_StrMap.empty;
  ...
  var dataType = Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(identifier)(function (v) {
      var $33 = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(v)(dataTypes);
      if ($33) {
  ...
  var typeDeclaration = Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(Perspectives_Syntax2.TypeDeclaration.create)(resourceName))(resourceName))(inLineComment);
  ...
  var rolePropertyAssignment = Text_Parsing_Indent.withPos(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(function (cb) {
      return function (pn) {
          return function (pv) {
              return function (cmt) {
                  return new Data_Tuple.Tuple({
                      commentBefore: cb, 
                      commentAfter: cmt
                  }, new Data_Tuple.Tuple(pn, [ Data_Show.show(Perspectives_Syntax2.showSimpleValue)(pv) ]));
              };
          };
      };
  })(manyOneLineComments))(propertyName))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(reservedOp("="))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(simpleValue)(dataType))))(inLineComment));
  ...
  var role = Text_Parsing_Indent.withPos(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(manyOneLineComments)(function (v) {
      return Text_Parsing_Indent.withPos(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(typeDeclaration)(function (v1) {
          return Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.indented)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.block(rolePropertyAssignment))(function (v2) {
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(new Perspectives_Syntax2.NamedEntityCollection(v1.value1, Data_StrMap.singleton(v1.value1)(new Perspectives_Syntax2.Rol({
                  id: v1.value1, 
                  pspType: v1.value0, 
                  binding: Data_Maybe.Nothing.value, 
                  context: v1.value1, 
                  properties: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Data_Tuple.snd)(v2)), 
                  gevuldeRollen: Data_StrMap.empty, 
                  comments: new Data_Maybe.Just({
                      commentBefore: v, 
                      commentAfter: Data_Maybe.Nothing.value, 
                      propertyComments: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (v3) {
                          return new Data_Tuple.Tuple(v3.value1.value0, v3.value0);
                      })(v2))
                  })
              }))));
          }));
  ...
  var typedPropertyAssignment = function (scope) {
      return Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Text_Parsing_Indent.withPos(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.apply(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Control_Monad_State_Trans.functorStateT(Data_Identity.functorIdentity)))(function (cb) {
          return function (pn) {
              return function (pv) {
                  return function (cmt) {
                      return new Data_Tuple.Tuple({
      ...
      })(manyOneLineComments))(reserved(scope)))(propertyName))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(reservedOp("="))))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(simpleValue)(dataType))))(inLineComment)));
  };

  // | privateContextPropertyAssignment = 'private' propertyName '=' simpleValue
  var privateContextPropertyAssignment = typedPropertyAssignment("private");

  // | publicContextPropertyAssignment = 'public' propertyName '=' simpleValue
  var publicContextPropertyAssignment = typedPropertyAssignment("public");
  var roleBinding = function (contextID) {
      return Text_Parsing_Indent.withPos(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(manyOneLineComments)(function (v) {
          return Text_Parsing_Indent.withPos(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(roleName)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(reservedOp("=>"))))(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(inLineComment)(function (v2) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.indented)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(context)(role)))(function (v3) {
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(new Perspectives_Syntax2.NamedEntityCollection(v3.value0, Data_StrMap.insert(v3.value0)(new Perspectives_Syntax2.Rol({
                          id: v3.value0, 
                          pspType: v1, 
                          binding: new Data_Maybe.Just(v3.value0), 
                          context: contextID, 
                          properties: Data_StrMap.empty, 
                          gevuldeRollen: Data_StrMap.empty, 
                          comments: Data_Maybe.Just.create({
                              commentBefore: v, 
                              commentAfter: v2, 
                              propertyComments: emptyPropertyComments
                          })
                      }))(v3.value1)));
                  });
              });
          }));
      })))(Text_Parsing_Indent.withPos(Text_Parsing_Parser_Combinators["try"](Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity))(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(manyOneLineComments)(function (v) {
          return Text_Parsing_Indent.withPos(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(roleName)(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(reservedOp("=>"))))(function (v1) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.sameOrIndented)(resourceName))(function (v2) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(inLineComment)(function (v3) {
                      return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.indented)(Text_Parsing_Indent.block(rolePropertyAssignment)))(function (v4) {
                          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Perspectives_Guid.guid(Data_Unit.unit)))(function (v5) {
                              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(new Perspectives_Syntax2.NamedEntityCollection(v5, Data_StrMap.singleton(v5)(new Perspectives_Syntax2.Rol({
                                  id: v5, 
                                  pspType: v1, 
                                  binding: new Data_Maybe.Just(v2), 
                                  context: contextID, 
                                  properties: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Data_Tuple.snd)(v4)), 
                                  gevuldeRollen: Data_StrMap.empty, 
                                  comments: Data_Maybe.Just.create({
                                      commentBefore: v, 
                                      commentAfter: v3, 
                                      propertyComments: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (v6) {
                                          return new Data_Tuple.Tuple(v6.value1.value0, v6.value0);
                                      })(v4))
                                  })
                              }))));
                          });
  ...
  var context = Text_Parsing_Indent.withPos(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(manyOneLineComments)(function (v) {
      return Text_Parsing_Indent.withPos(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(typeDeclaration)(function (v1) {
          return Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.indented)(Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.block(publicContextPropertyAssignment))(function (v2) {
              return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.block(privateContextPropertyAssignment))(function (v3) {
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(Text_Parsing_Indent.block(roleBinding(v1.value1)))(function (v4) {
                      var buitenRol = {
                          id: v1.value1 + "_buitenRol", 
                          pspType: ":BuitenRol", 
                          binding: Data_Maybe.Nothing.value, 
                          context: v1.value1, 
                          properties: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Data_Tuple.snd)(v2)), 
                          ...
                          comments: Data_Maybe.Just.create({
                              commentBefore: [  ], 
                              commentAfter: Data_Maybe.Nothing.value, 
                              propertyComments: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (v5) {
                                  return new Data_Tuple.Tuple(v5.value1.value0, v5.value0);
                              })(v2))
                          })
                      };
                      var binnenRol = {
                          id: v1.value1 + "_binnenRol", 
                          pspType: ":BinnenRol", 
                          binding: Data_Maybe.Just.create(v1.value1 + "_buitenRol"), 
                          properties: Data_StrMap.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(Data_Tuple.snd)(v3))
                      };
                      var ctxt = {
                          id: v1.value1, 
                          pspType: v1.value0, 
                          binnenRol: binnenRol, 
                          buitenRol: v1.value1 + "_buitenRol", 
                          rolInContext: Data_Array.fromFoldable(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (v5) {
                              return v5.value0;
                          })(v4)), 
                          comments: Data_Maybe.Just.create({
                              commentBefore: v, 
                      ...
                      var v5 = Data_StrMap.unions(Data_List_Types.foldableList)(Data_Functor.map(Data_List_Types.functorList)(function (v6) {
                          return v6.value1;
                      })(v4));
                      return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Control_Monad_State_Trans.monadStateT(Data_Identity.monadIdentity)))(new Perspectives_Syntax2.NamedEntityCollection(v1.value1, Data_StrMap.insert(v1.value1)(new Perspectives_Syntax2.Context(ctxt))(Data_StrMap.insert(v1.value1 + "_buitenRol")(new Perspectives_Syntax2.Rol(buitenRol))(v5))));
                  });
              });
          }));
      }));
  ...
  exports["emptyPropertyComments"] = emptyPropertyComments;
  ...
  exports["lower"] = lower;
  exports["manyOneLineComments"] = manyOneLineComments;
...
(function(exports) {
  ...
  var AceSlot = (function () {
      function AceSlot(value0) {
          this.value0 = value0;
      };
      AceSlot.create = function (value0) {
          return new AceSlot(value0);
      };
      return AceSlot;
  })();
  var parse = function (source) {
      var v = Perspectives_IndentParser.runIndentParser(source)(Perspectives_ContextRoleParser.context);
      if (v instanceof Data_Either.Right) {
          return Data_Show.show(Perspectives_Syntax2.showEntityCollection)(v.value0.value1);
      };
      if (v instanceof Data_Either.Left) {
          return Data_Show.show(Text_Parsing_Parser.showParseError)(v.value0);
      };
      throw new Error("Failed pattern match at Main line 99, column 16 - line 101, column 21: " + [ v.constructor.name ]);
  };
  ...
  var ui = (function () {
      ...
      var handlePerspectOutput = function (v) {
          return Data_Maybe.Just.create(Halogen_Query.action(HandleAceUpdate.create(parse(v.value0))));
      };
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("ace editor") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ClearText.create)) ])([ Halogen_HTML_Core.text("Clear") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(Load.create)) ])([ Halogen_HTML_Core.text("Load") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML.slot(new AceSlot(1))(PerspectAceComponent.aceComponent("ace/mode/perspectives")("ace/theme/perspectives"))(Data_Unit.unit)(handlePerspectOutput) ]), Halogen_HTML_Elements.div_([ Halogen_HTML.slot(new AceSlot(2))(PerspectAceComponent.aceComponent("ace/mode/json")("ace/theme/perspectives"))(Data_Unit.unit)(Data_Function["const"](Data_Maybe.Nothing.value)) ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Core.text("Current text: " + v.text) ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof ClearText) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqAceSlot)(new AceSlot(1))(Halogen_Query.action(PerspectAceComponent.ChangeText.create(""))))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          if (v instanceof HandleAceUpdate) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqAceSlot)(new AceSlot(2))(Halogen_Query.action(PerspectAceComponent.ChangeText.create(v.value0))))(function (v1) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              });
          };
          if (v instanceof Load) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Network_HTTP_Affjax.get(Network_HTTP_Affjax_Response.responsableString)("http://www.pureperspectives.nl/src/editor/perspectives.psp")))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqAceSlot)(new AceSlot(1))(Halogen_Query.action(PerspectAceComponent.ChangeText.create(v1.response))))(function (v2) {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Main line 80, column 3 - line 82, column 14: " + [ v.constructor.name ]);
      };
