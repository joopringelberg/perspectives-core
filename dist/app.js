...
(function(exports) {
  ...
  var ui = (function () {
      ...
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("ace editor") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ClearText.create)) ])([ Halogen_HTML_Core.text("Clear") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML.slot(AceSlot.value)(AceComponent.aceComponent)(Data_Unit.unit)(handleAceOuput) ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text("Current text: " + v.text) ]) ]);
      };
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Main line 67, column 3 - line 69, column 14: " + [ v.constructor.name ]);
      };
