      ...
      var $$eval = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.getHTMLElementRef("ace"))(function (v1) {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Ace.editNode(v1.value0)(Ace.ace)))(function (v2) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Ace_Editor.getSession(v2)))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                  var $16 = {};
                                  for (var $17 in v4) {
                                      if ({}.hasOwnProperty.call(v4, $17)) {
                                          $16[$17] = v4[$17];
                                      };
                                  };
                                  $16.editor = new Data_Maybe.Just(v2);
                                  return $16;
                              }))(function () {
                  ...
                  throw new Error("Failed pattern match at AceComponent line 64, column 50 - line 70, column 91: " + [ v1.constructor.name ]);
              }))(function () {
          ...
          if (v instanceof Finalize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $21.editor = Data_Maybe.Nothing.value;
                  return $21;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          ...
          if (v instanceof ChangeText) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at AceComponent line 79, column 7 - line 84, column 67: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          if (v instanceof HandleChange) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      ...
                      throw new Error("Failed pattern match at AceComponent line 89, column 7 - line 93, column 37: " + [ v1.constructor.name ]);
                  })())(function () {
          ...
          throw new Error("Failed pattern match at AceComponent line 62, column 10 - line 94, column 30: " + [ v.constructor.name ]);
      };
...
(function(exports) {
  ...
  var ui = (function () {
      ...
      var render = function (v) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("ace editor") ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.p_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ClearText.create)) ])([ Halogen_HTML_Core.text("Clear") ]) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML.slot(AceSlot.value)(AceComponent.aceComponent)(Data_Unit.unit)(handleAceOuput) ]), Halogen_HTML_Elements.pre_([ Halogen_HTML_Core.text("Current text: " + v.text) ]) ]);
      };
      var $$eval = function (v) {
          if (v instanceof ClearText) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query.query(eqAceSlot)(AceSlot.value)(Halogen_Query.action(AceComponent.ChangeText.create(""))))(function (v1) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
