...
var print = function (v) {
    ...
    return URI_Path_Segment.printSegmentNZNC(v.value0) + ("/" + Data_String.joinWith("/")(Data_Functor.map(Data_Functor.functorArray)(URI_Path_Segment.printSegment)(v.value1)));
};
var parse = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(URI_Path_Segment.parseSegmentNZNC)(function (v) {
...
var genericPathNoScheme = new Data_Generic_Rep.Generic(function (x) {
    return x;
}, function (x) {
    return x;
});
var showPathNoScheme = new Data_Show.Show(Data_Generic_Rep_Show.genericShow(genericPathNoScheme)(Data_Generic_Rep_Show.genericShowConstructor(Data_Generic_Rep_Show.genericShowArgsArgument(Data_Tuple.showTuple(URI_Path_Segment.showPathSegmentNZNC)(Data_Show.showArray(URI_Path_Segment.showPathSegment))))(new Data_Symbol.IsSymbol(function () {
    return "PathNoScheme";
}))));
var eqPathNoScheme = new Data_Eq.Eq(function (x) {
    return function (y) {
...
var ordPathNoScheme = new Data_Ord.Ord(function () {
