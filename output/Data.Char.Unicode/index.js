...
var unicodeCatToGeneralCat = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Char.Unicode line 169, column 1 - line 169, column 61: " + [ v.constructor.name ]);
};
var toUpper = function ($50) {
    return Data_Char.fromCharCode(Data_Char_Unicode_Internal.uTowupper(Data_Char.toCharCode($50)));
};
var toTitle = function ($51) {
    return Data_Char.fromCharCode(Data_Char_Unicode_Internal.uTowtitle(Data_Char.toCharCode($51)));
};
...
var showGeneralCategory = new Data_Show.Show(function (v) {
    ...
    throw new Error("Failed pattern match at Data.Char.Unicode line 201, column 1 - line 201, column 53: " + [ v.constructor.name ]);
});
...
var isPrint = function ($54) {
    return Data_Char_Unicode_Internal.uIswprint(Data_Char.toCharCode($54));
};
...
var isControl = function ($56) {
    return Data_Char_Unicode_Internal.uIswcntrl(Data_Char.toCharCode($56));
};
...
var generalCategory = function ($59) {
    return Data_Functor.map(Data_Maybe.functorMaybe)(unicodeCatToGeneralCat)(Data_Char_Unicode_Internal.uGencat(Data_Char.toCharCode($59)));
};
...
var generalCatToUnicodeCat = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Char.Unicode line 137, column 1 - line 137, column 61: " + [ v.constructor.name ]);
};
var generalCatToInt = function (v) {
    ...
    throw new Error("Failed pattern match at Data.Char.Unicode line 105, column 1 - line 105, column 42: " + [ v.constructor.name ]);
};
