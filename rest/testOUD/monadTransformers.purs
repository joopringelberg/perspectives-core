...
{-
I have functions whose type is
    forall e a b. a -> Aff e (Either Error (Maybe b))
for some extensible set of effects e and where Error is an alias for String.
I would like to compose these functions.
Obviously, ordinary composition does not work.
Neither will Kleisli composition, because that will merely break through the outer Aff monad, then
