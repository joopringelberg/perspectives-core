...
runPhaseTwo computation =  runState (runExceptT computation) {bot: false, dfr: defaultDomeinFileRecord}
...
evalPhaseTwo computation = evalState (runExceptT computation) {bot: false, dfr: defaultDomeinFileRecord}
