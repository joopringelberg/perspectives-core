...
import Data.Array (filterA, fold, head, intercalate, nub, union)
...
import Perspectives.Query.QueryTypes (range, roleRange)
...
import Prelude (Unit, bind, const, discard, join, map, not, pure, show, unit, when, ($), (<$>), (<<<), (<>), (==), (>=>), (>>=))
